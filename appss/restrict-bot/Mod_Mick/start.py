...
from Mod_Mick.strings import HELP_TXT
...
async def send_start(client: Client, message: Message):
    ...
    buttons = [[
        InlineKeyboardButton("Developer Mod Mick❣️", url = "https://t.me/mod_mick")
    ],[
        InlineKeyboardButton('🔍 sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ', url='https://t.me/mod_mick_support'),
        InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ', url='https://t.me/mod_mick')
    ]]
